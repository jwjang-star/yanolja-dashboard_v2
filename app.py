...
# 💡 [전처리] 텍스트 공백 제거 및 숫자 변환
    ...
    # 💡 [새로운 진단 코드] 대시보드 화면 대신 VS Code 터미널에 출력합니다.
    print("=========================================")
    print("🔍 [매치 파일 진단 결과]")
    print(f"1. df_c(매치파일) 전체 행 개수: {len(df_c)}")
    print(f"2. 병합 후 자사 데이터: {len(df_final[df_final['구분']=='자사'])}")
    print(f"3. 병합 후 경쟁사 데이터: {len(df_final[df_final['구분']=='경쟁사'])}")
    print("=========================================")    
